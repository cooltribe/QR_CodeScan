		...
		try {
			...
			mWebView.setWebChromeClient(new WebChromeClient(){
				...
				public void onProgressChanged(WebView view, int progress){
					...
					MainActivity1.this.setProgress(progress);
					
					if(progress >= 80) {
						MainActivity1.this.setTitle("JsAndroid Test");
					}
				}
			});
...
//			}
			public void HtmlcallJava(){
				Intent intent = new Intent(MainActivity1.this, MipcaActivityCapture.class);
			...
			public void JavacallHtml(){
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						Toast.makeText(MainActivity1.this, "clickBtn", Toast.LENGTH_SHORT).show();
					}
				});
			}
			...
			public void JavacallHtml2(){
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						Toast.makeText(MainActivity1.this, "clickBtn2", Toast.LENGTH_SHORT).show();
					}
				});
			}
		};
